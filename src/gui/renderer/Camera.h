 ...
 * @note Further code forked from my privately developed "misc" and "magtools" project (https://github.com/t-weber/misc and https://github.com/t-weber/magtools).
 * @note Class copied back to tlibs2 on 10-jan-2022 for generalisation.
...
#ifndef __TASPATHS_RENDERER_CAM_H__
#define __TASPATHS_RENDERER_CAM_H__
